...
openai.api_key = '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'
...
format_type = st.sidebar.selectbox('Виберіть свого чарівника OpenAI 😉',["ChatGPT","DALL-E 2"])
...
if format_type == "ChatGPT":
    input_text = st.text_area("Введіть текст тут... 🙋",height=50)
    chat_button = st.button("Зробіть магію! ✨")
    ...
    if chat_button and input_text.strip() != "":
        ...
        st.warning("Будь ласка, введіть щось! ⚠")

else:
    input_text = st.text_area("Введіть текст тут... 🙋",height=50)
    image_button = st.button("Створити зображення 🚀")
